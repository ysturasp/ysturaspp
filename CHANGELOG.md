- replace link on LK due with error 500 on ystuty frontend service (ysturasp, 2025-06-28) [0 insertions(+), 0 deletions(-)]
- Changed: 'https://id.ystuty.ru/' --> 'https://ystu.expo.app' [15 files changed, 15 insertions(+), 15 deletions(-)]
- add all metrics (ysturasp, 2025-06-26) [1 file changed, 51 insertions(+)]
- add new page with library custom components by ysturasp (ysturasp, 2025-06-26) [1 file changed, 2023 insertions(+)]
- Update FUNDING.yml (ysturasp, 2025-06-23) [0 insertions(+), 0 deletions(-)]
- Create FUNDING.yml (ysturasp, 2025-06-23) [1 file changed, 15 insertions(+)]
- add section for notify users about active develop parser for schedule prepods and audience (ysturasp, 2025-06-22) [2 files changed, 34 insertions(+)]
- update notification if actual day is holidays (ysturasp, 2025-06-18) [1 file changed, 6 insertions(+), 1 deletion(-)]
- add message if all subjects in day hidden (ysturasp, 2025-06-02) [2 files changed, 19 insertions(+)]
- improve drag handling for carousel, and update transition animations (ysturasp, 2025-06-01) [2 files changed, 124 insertions(+), 42 deletions(-)]
